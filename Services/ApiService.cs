...
namespace BlazorFrontEnd.Services
{
    ...
    public class ApiService
    {
        ...
        // Para String como PK:
        public async Task<bool> EditEntityAsyncStr(string endpoint, string id, Dictionary<string, object> entity)
        {
            try
            {
                // Realiza una petición PUT al endpoint especificado con la entidad como contenido JSON
        ...
        //Para String como PK:
        public async Task<bool> DeleteEntityAsyncStr(string endpoint, string id)
        {
            try
            {
                // Realiza una petición DELETE al endpoint especificado
